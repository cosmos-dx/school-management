These MAPI headers were downloaded from https://www.microsoft.com/en-us/download/details.aspx?id=12905
and enable us to build the MAPI extension in Python 2.7 and up.

The terms for these headers are below:
