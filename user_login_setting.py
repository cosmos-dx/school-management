...
class User_Login(Frame):
    ...
    def initUI(self):
        ...
        wrow += 1
        self.login_id = RMS_LABEL(self.master, text="ENTER_LOGIN_ID :", **lfnt_fg_bg)
        self.login_id.grid(row=wrow, column=1, rowspan=1, columnspan=1, sticky='w')
        self.txt1 = RMS_ENTRY(self.master, textvariable=StringVar(), **efnt_fg_bg)
        self.txt1.grid(row=wrow, column=2, rowspan=1, columnspan=4, sticky='w')
        wrow += 1
        self.old_pass = RMS_LABEL(self.master, text="OLD PASSWORD :", **lfnt_fg_bg)
        self.old_pass.grid(row=wrow, column=1, rowspan=1, columnspan=1, sticky='w')
        self.txt2 = RMS_ENTRY(self.master, show="*", textvariable=StringVar(), **efnt_fg_bg)
        self.txt2.grid(row=wrow, column=2, rowspan=1, columnspan=4, sticky='w')
        wrow += 1
        
        self.new_login_id = RMS_LABEL(self.master, text="NEW LOGIN ID :", **lfnt_fg_bg)
        self.new_login_id.grid(row=wrow, column=1, rowspan=1, columnspan=1, sticky='w')
        self.new_txt1 = RMS_ENTRY(self.master, textvariable=StringVar(), **efnt_fg_bg)
        self.new_txt1.grid(row=wrow, column=2, rowspan=1, columnspan=4, sticky='w')
        wrow += 1
        
        self.new_pass = RMS_LABEL(self.master, text="NEW PASSWORD :", **lfnt_fg_bg)
        self.new_pass.grid(row=wrow, column=1, rowspan=1, columnspan=1, sticky='w')
        self.txt3 = RMS_ENTRY(self.master, show="*", textvariable=StringVar(), **efnt_fg_bg)
        self.txt3.grid(row=wrow, column=2, rowspan=1, columnspan=4, sticky='w')
        wrow += 1
        self.conf_pass = RMS_LABEL(self.master, text="CONFIRM PASSWORD :", **lfnt_fg_bg)
        self.conf_pass.grid(row=wrow, column=1, rowspan=1, columnspan=1, sticky='w')
        self.txt4 = RMS_ENTRY(self.master, show="*", textvariable=StringVar(), **efnt_fg_bg)
        self.txt4.grid(row=wrow, column=2, rowspan=1, columnspan=4, sticky='w')
        wrow += 2
        ...
        self.txt1.bind('<Key>', self.txt1_key)
        self.txt2.bind('<Key>', self.txt2_key)
        self.new_txt1.bind('<Key>', self.new_txt1_key)
        self.txt3.bind('<Key>', self.txt3_key)
        self.txt4.bind('<Key>', self.txt4_key)
